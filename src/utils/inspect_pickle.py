...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Inspect generated Pickle dataset files.")
    parser.add_argument("--base_dir", type=str, required=True, help="Directory where .pkl files are saved")
    parser.add_argument("--prefix", type=str, required=True, help="Output prefix used")
    parser.add_argument("--samples", type=int, default=5, help="Number of samples to print per split")
