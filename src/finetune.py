...
from train_and_eval import train, get_train_loader, get_val_loader
...
def freeze_layers(model, freeze_level):
    ...
    if freeze_level == "none":
        ...
        print(f"Warning: Unknown freeze level '{freeze_level}'. Valid options are: none, stem, layer1, layer2, layer3.")
...
if __name__ == "__main__":
    ...
    # Required Paths
    parser.add_argument("--weights", type=str, required=True, help="Path to the pre-trained .pth model")
    parser.add_argument("--train_pkl", type=str, required=True, help="Path to the real train data .pkl")
    parser.add_argument("--val_pkl", type=str, required=True, help="Path to the real val data .pkl")
    parser.add_argument("--save_dir", type=str, required=True, help="Directory to save the fine-tuned checkpoints")
    ...
    # Freezing Argument
    parser.add_argument("--freeze_level", type=str, default="layer1", 
